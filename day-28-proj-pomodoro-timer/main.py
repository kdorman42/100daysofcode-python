...
canvas.grid(column=1, row=1) #4 rows 3 cols?

start_button = Button(text="Start", highlightthickness=0, command=start_timer)  # NO PARENS on function!!
...
window.mainloop()  # event driven program
